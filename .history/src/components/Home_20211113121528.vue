		...
		.card-body
			...
			.alert.alert-warning.my-2
				.flex-1
					...
					label Semakin besar ukuran berkas foto mu, semakin lama fotomu akan diproses. Prosesnya semua bergantung kepada spek perangkat mu karena prosesnya di proses oleh peramban di perangkat mu dan berkas foto mu tidak dikirim ke server ya.
			...
			.card.shadow-2xl.bg-green-400
				.card-body
					...
					.form-control
						...
						input.input.input-bordered(type="number" min="0" v-model="options.yoffset" )
